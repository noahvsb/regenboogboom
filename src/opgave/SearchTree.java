...
public interface SearchTree<E extends Comparable<E>> {
     ...
     *
     * The newly rebuilt tree should be restructured according to the properties of the tree and should not contain tombstones.
     */
    void rebuild();
     ...
     *
     * @return a list with all included values (not tombstones) included in this tree
     */
    List<E> values();
}
